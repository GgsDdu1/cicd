...
def parse_args():
    ...
    parser.add_argument('--config_file', default='kairos/configs/kairos_4b_config_DMD.py', help='config_file')
...
if __name__ == '__main__':
    ...
    if os.getenv("DETAILED_PERF_ENABLE", False):
        ...
        print("max_memory_allocated (GB):", torch.cuda.max_memory_allocated() / 1024**3)
